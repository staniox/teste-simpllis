...
<template>
    <AuthenticatedLayout>
        ...
        <template #header class="bg-gray-500">
            ...
            <Link class="bg-green-500 text-white font-semibold py-2 px-4 rounded-md" :href="route('cars.create')" :active="route().current('cars.create')">
                Novo
            </Link>
        </template>
        <div class="py-12">
                ...
                >
                    ...
                    <template #item-operation="item">
                        <div class="inline-flex">
                            <Link :href="route('cars.edit',item.id)">
